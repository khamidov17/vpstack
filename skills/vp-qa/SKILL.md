...
```bash
eval "$(~/.claude/skills/vpstack/bin/vpstack-skill-init vp-qa 2>/dev/null || .claude/skills/vpstack/bin/vpstack-skill-init vp-qa 2>/dev/null || echo 'ACTIVATION=NO_MATCH')"
