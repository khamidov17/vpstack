...
```bash
eval "$(~/.claude/skills/vpstack/bin/vpstack-skill-init vp-plan-eng-review 2>/dev/null || .claude/skills/vpstack/bin/vpstack-skill-init vp-plan-eng-review 2>/dev/null || echo 'ACTIVATION=NO_MATCH')"
