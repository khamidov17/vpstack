...
```bash
eval "$(~/.claude/skills/vpstack/bin/vpstack-skill-init vp-attack 2>/dev/null || .claude/skills/vpstack/bin/vpstack-skill-init vp-attack 2>/dev/null || echo 'ACTIVATION=NO_MATCH')"
